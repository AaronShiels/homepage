...
resource "aws_s3_object" "this" {
  ...
  content_type = endswith(each.value, ".html") ? "text/html" : endswith(each.value, ".js") ? "text/javascript" : endswith(each.value, ".css") ? "text/css" : endswith(each.value, ".png") ? "image/png" : endswith(each.value, ".svg") ? "image/svg+xml" : "text/plain"
